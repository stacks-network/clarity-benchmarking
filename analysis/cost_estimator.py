...
def main():
    ...
    estimate_plot(df, 'cost_bitwise_and', output)
    estimate_plot(df, 'cost_bitwise_or', output)
    estimate_plot(df, 'cost_bitwise_not', output)
    estimate_plot(df, 'cost_bitwise_left_shift', output)
    estimate_plot(df, 'cost_bitwise_right_shift', output)
